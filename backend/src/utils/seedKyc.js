...
async function seedKyc() {
  try {
    ...
    await Employee.bulkCreate([
      { name: 'John Doe', email: 'john.doe@company.com', department: 'Engineering', role: 'Software Engineer', hireDate: '2023-01-15', salary: 75000, status: 'active' },
      { name: 'Jane Smith', email: 'jane.smith@company.com', department: 'Product', role: 'Product Manager', hireDate: '2022-08-20', salary: 85000, status: 'active' },
      { name: 'Mike Johnson', email: 'mike.johnson@company.com', department: 'Sales', role: 'Sales Representative', hireDate: '2023-03-10', salary: 65000, status: 'active' }
    ]);
    ...
    const kycData = [
      ...
      },
      {
        ...
        reviewedBy: 'Admin User',
        remarks: 'Document quality is poor. Please resubmit with clearer images.'
      }
    ];
    ...
    createdKyc.forEach(kyc => {
      console.log(`- ${kyc.fullName} (${kyc.status}) - ${kyc.documentType.toUpperCase()}`);
    });
