...
export default function EmployeePayslip() {
  ...
  const fetchPayslips = useCallback(async () => {
    try {
      ...
      const response = await apiService.getEmployeePayslips(
        employee.employeeId,
        null,
        selectedYear
      );
  ...
  }, [user?.email, selectedYear, fetchPayslips]);
    ...
    try {
      ...
      const payslipData = {
        ...
        grossSalary: parseFloat(
          payslip.grossSalary || payslip.earnedSalary || 0
        ),
      ...
      toast.error(
        error.message ||
          "Failed to download payslip. Please check the console for details."
      );
    }
  };
        ...
        <Card>
          <CardContent className="text-center py-12">
            ...
            <p className="text-muted-foreground mb-2">
              No payslips have been generated for you for the year{" "}
              {selectedYear}.
            </p>
            <p className="text-sm text-muted-foreground">
              Payslips are typically generated monthly by HR. If you believe
                ...
                {payslip.leaveDeduction > 0 && (
                  <div className="mt-4 p-3 bg-orange-50 border border-orange-200 rounded-lg">
                    ...
                    <p className="text-sm text-orange-700 mt-1">
                      {formatCurrency(payslip.leaveDeduction)} deducted for{" "}
                      {payslip.leaveDays} leave days
                    </p>
                  </div>
                )}
                ...
                <div className="mt-4 pt-4 border-t">
                  <div className="flex items-center justify-between text-sm text-muted-foreground">
                    ...
                    <Button
                      ...
                      onClick={() =>
                        setSelectedPayslip(
                          selectedPayslip === payslip.id ? null : payslip.id
                        )
                      }>
                        ...
                        <div className="space-y-1">
                          ...
                          {(payslip.leaveDeduction || 0) > 0 && (
                            <div className="flex justify-between text-orange-600">
                              ...
                              <span>
                                -{formatCurrency(payslip.leaveDeduction)}
                              </span>
                            </div>
                          )}
