 ...
 * @property {Object} [k] - Chart configuration for each key
 * @property {React.ReactNode} [label] - Label for the chart element
 * @property {React.ComponentType} [icon] - Icon component
 * @property {string} [color] - Color for the chart element
